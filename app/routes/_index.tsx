    ...
    <>
      <div id="topbar" className="d-flex align-items-center fixed-top">
        <div className="container d-flex justify-content-between">
          ...
          <div className="d-none d-lg-flex social-links align-items-center">
            <Link to="/twitter" className="twitter"><i className="bi bi-twitter"></i></Link>
            <Link to="/facebook" className="facebook"><i className="bi bi-facebook"></i></Link>
            <Link to="/instagram" className="instagram"><i className="bi bi-instagram"></i></Link>
            <Link to="/linkedin" className="linkedin"><i className="bi bi-linkedin"></i></Link>
          </div>
        </div>
      </div>
      ...
      <header id="header" className="fixed-top">
        <div className="container d-flex align-items-center">
          ...
          {/* <Link to="/" className="logo me-auto"><img src="/assets/img/logo.png" alt="Medilab" className="img-fluid"></Link> */}
          ...
          <nav id="navbar" className="navbar order-last order-lg-0">
            <ul>
              ...
              <li><a href="#">Drop Down <i className="bi bi-chevron-down"></i></a></li>
